...
class Ffuenf_ConfigDotEnv_Helper_Data extends Ffuenf_Common_Helper_Core
{
    /**
     * Path for the config for extension active status.
     */
    const CONFIG_EXTENSION_ACTIVE = 'ffuenf_configdotenv/general/enable';

    /**
     * Path for the config for extension system log status.
     */
    const CONFIG_EXTENSION_LOG_SYSTEM_ACTIVE = 'ffuenf_configdotenv/log/enable';

    /**
     * Path for the config for extension profile log status.
     */
    const CONFIG_EXTENSION_LOG_PROFILE_ACTIVE = 'ffuenf_configdotenv/log/profile_enable';

    /**
     * Path for the config for extension exception log status.
     */
    const CONFIG_EXTENSION_LOG_EXCEPTION_ACTIVE = 'ffuenf_configdotenv/log/exception_enable';
